package dev.kosmaj.movieinfoservice.model;
...
public class MovieSummary {
	...
	public String toString() {
		return "MovieSummary [adult=" + adult + ", backdrop_path=" + backdrop_path + ", Belongs_to_collectionObject="
				+ Belongs_to_collectionObject + ", budget=" + budget + ", genres=" + genres + ", homepage=" + homepage
